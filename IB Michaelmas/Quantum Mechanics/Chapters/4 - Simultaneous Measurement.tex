...
\begin{propositions}{
    ...
    \item $\cmmt{A}{A} = 0$
    \item $[\hat{A}, \hat{B}\hat{C}] = \cmmt{A}{B}\hat{C} + \hat{B}\cmmt{A}{C}$ \label{propCmmtExpand2Arg}
    \item $[\hat{A}\hat{B}, \hat{C}] = \hat{A}\cmmt{B}{C} + \cmmt{A}{C}\hat{B}$ \label{propCmmtExpand1Arg}
\end{propositions}
